...
public class Ruang_Rapat extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        title.setText("Ruang Rapat");
        tempat = (TextView) findViewById(R.id.tempat);
        tempat.setText("Ruang Rapat");
    ...
    private final SensorEventListener LightSensorListener = new SensorEventListener()
    {
        ...
        public void onSensorChanged(SensorEvent event)
        {
            ...
            if ((+event.values[0]) <= 5)
            {
                AlertDialog.Builder builder = new AlertDialog.Builder(Ruang_Rapat.this);
                builder.setTitle("Perhatian");
                builder.setMessage(" letakkan ponsel di tempat yang cukup cahaya konoyaro !");
                builder.setCancelable(true);
                final AlertDialog dlg = builder.create();
                dlg.show();
                Handler mHandler = new Ruang_Rapat.handler();
...
//            }
            ...
            else if ((+event.values[0]) > 60 && (+event.values[0]) <= 120)
            {
                area.setText(" RUANG RAPAT ");
