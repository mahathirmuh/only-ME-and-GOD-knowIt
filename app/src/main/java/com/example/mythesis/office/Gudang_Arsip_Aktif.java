...
public class Gudang_Arsip_Aktif extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        title.setText("Gudang Arsip Aktif");
        tempat = (TextView) findViewById(R.id.tempat);
        tempat.setText("Gudang Arsip Aktif");
    ...
    private final SensorEventListener LightSensorListener = new SensorEventListener()
    {
        ...
        public void onSensorChanged(SensorEvent event)
        {
            ...
            if ((+event.values[0]) <= 5)
            {
                ...
                dlg.show();
                Handler mHandler = new Gudang_Arsip_Aktif.handler();
