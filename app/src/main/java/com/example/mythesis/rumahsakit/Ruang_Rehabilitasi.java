...
public class Ruang_Rehabilitasi extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        title.setText("Ruang Rehabilitasi");
        tempat = (TextView) findViewById(R.id.tempat);
        tempat.setText("Ruang Rehabilitasi");
    ...
    private final SensorEventListener LightSensorListener = new SensorEventListener()
    {
        ...
        public void onSensorChanged(SensorEvent event)
        {
            ...
            if ((+event.values[0]) <= 5)
            {
                ...
                dlg.show();
                Handler mHandler = new Ruang_Rehabilitasi.handler();
